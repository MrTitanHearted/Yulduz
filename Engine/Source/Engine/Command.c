...
void YULDUZ_EnsureDenseCapacityInCommandBuffer(YULDUZ_CommandBuffer *command_buffer);
void YULDUZ_EnsureArenaCapacityInCommandBuffer(YULDUZ_CommandBuffer *command_buffer, uint32_t required_size);
...
bool YULDUZ_PushCommandInCommandBuffer(YULDUZ_CommandBuffer *command_buffer, const YULDUZ_Command *command) {
    YULDUZ_EnsureDenseCapacityInCommandBuffer(command_buffer);
...
uint32_t YULDUZ_PushArenaDataInCommandBuffer(YULDUZ_CommandBuffer *command_buffer, uint32_t size, const void *data) {
    ...
    YULDUZ_EnsureArenaCapacityInCommandBuffer(command_buffer, size);
