...
typedef void (*YULDUZ_SystemPFN)(YULDUZ_Archetype *archetype, const YULDUZ_Query *query, void *user_data);
...
YULDUZ_API bool YULDUZ_RunSystem(YULDUZ_System *system, YULDUZ_ECSRegistry *registry, void *user_data);