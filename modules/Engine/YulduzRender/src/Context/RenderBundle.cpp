...
namespace Yulduz {
    ...
    void RenderBundleEncoder::setVertexBuffer(std::uint32_t slot, const std::shared_ptr<VertexBuffer> &buffer) {
        m_Buffers.emplace_back(buffer);
    ...
    void RenderBundleEncoder::setBindGroup(std::uint32_t groupIndex, const std::shared_ptr<BindGroup> &bindGroup) {
        m_BindGroups.emplace_back(bindGroup);
        wgpuRenderBundleEncoderSetBindGroup(m_RenderBundleEncoder, groupIndex, bindGroup->get(), 0, nullptr);
    }

    void RenderBundleEncoder::draw(std::uint32_t slot, const std::shared_ptr<VertexBuffer> &buffer) {
        m_Buffers.emplace_back(buffer);
        wgpuRenderBundleEncoderSetVertexBuffer(m_RenderBundleEncoder, slot, buffer->get(), 0, buffer->getSize());
    ...
    RenderBundleEncoderBuilder &RenderBundleEncoderBuilder::addColorFormatReq(TextureFormat colorFormat) {
