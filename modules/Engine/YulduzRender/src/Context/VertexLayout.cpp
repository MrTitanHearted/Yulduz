...
namespace Yulduz {
    ...
    VertexLayout &VertexLayout::addAttribute(VertexFormat format, std::size_t offset, std::uint32_t shaderLocation) {
        m_VertexAttributes.emplace_back(WGPUVertexAttribute{
    ...
    WGPUVertexBufferLayout VertexLayout::Get(const VertexLayout &layout) {
        return WGPUVertexBufferLayout{
            ...
            .attributeCount = static_cast<std::uint32_t>(layout.m_VertexAttributes.size()),
