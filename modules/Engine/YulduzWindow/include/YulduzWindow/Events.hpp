...
namespace Yulduz {
    ...
    class WindowResizeEvent : public WindowEvent {
       public:
        ...
        WindowResizeEvent(Window *window, std::uint32_t width, std::uint32_t height)
    ...
    class WindowMoveEvent : public WindowEvent {
       public:
        ...
        WindowMoveEvent(Window *window, std::uint32_t x, std::uint32_t y) : x(x), y(y) {
            this->window = window;
        }
    };
    ...
    class WindowCharEvent : public WindowEvent {
       public:
        ...
        WindowCharEvent(Window *window, std::uint32_t codepoint) : codepoint(codepoint) {
            this->window = window;
        }
    };
