...
static void ImGui_ImplWGPU_CreateWindow(ImGuiViewport* viewport)
{
    ...
    WGPUSurfaceDescriptorFromWindowsHWND surfaceDescFromHandle = WGPUSurfaceDescriptorFromWindowsHWND();
    ...
    WGPUSurfaceDescriptorFromMetalLayer surfaceDescFromHandle = WGPUSurfaceDescriptorFromMetalLayer();
...
//     chainedDescriptor.sType = WGPUSType_SurfaceDescriptorFromWindowsHWND;
//     WGPUSurfaceDescriptorFromWaylandSurface surfaceDescFromHandle = WGPUSurfaceDescriptorFromWaylandSurface();
